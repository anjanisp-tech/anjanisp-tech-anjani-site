      ...
      <header className="sticky top-0 left-0 right-0 bg-white/95 backdrop-blur-md z-50 border-b border-border">
        <div className="container-custom h-24 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-10">
            ...
            <Link to="/calculator" className="text-sm font-semibold text-accent/70 hover:text-accent transition-colors">Founder Tax</Link>
        ...
        {isMenuOpen && (
          <div className="md:hidden bg-white border-b border-border p-6 flex flex-col gap-4 animate-in fade-in slide-in-from-top-5">
            ...
            <Link to="/calculator" className="text-lg font-medium py-2">Founder Tax</Link>
            ...
            <div className="grid grid-cols-2 gap-8">
              <div className="space-y-4">
                ...
                <nav className="flex flex-col gap-2 text-sm font-medium">
                  ...
                  <Link to="/calculator" className="hover:text-accent transition-colors">Founder Tax Calculator</Link>
