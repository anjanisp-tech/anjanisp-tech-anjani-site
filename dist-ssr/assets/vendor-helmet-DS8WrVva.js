...
function requireReact_development() {
  ...
  (function(module, exports$1) {
    "production" !== process.env.NODE_ENV && (function() {
      ...
      exports$1.createContext = function(defaultValue2) {
        defaultValue2 = {
          $$typeof: REACT_CONTEXT_TYPE,
          _currentValue: defaultValue2,
          _currentValue2: defaultValue2,
        ...
        defaultValue2._currentRenderer = null;
        defaultValue2._currentRenderer2 = null;
        return defaultValue2;
      };
      ...
      exports$1.useContext = function(Context2) {
...
const React5 = /* @__PURE__ */ getDefaultExportFromCjs(reactExports);
...
var defaultValue = {};
var Context = React5.createContext(defaultValue);
var HelmetProvider = (_a = class extends reactExports.Component {
  ...
  render() {
    if (isReact19) {
      return /* @__PURE__ */ React5.createElement(React5.Fragment, null, this.props.children);
    }
...
var React19Dispatcher = class extends reactExports.Component {
  ...
  renderMeta() {
    ...
    if (!meta || !Array.isArray(meta))
      return null;
    return meta.map(
      (attrs, i) => React5.createElement("meta", {
        key: i,
        ...toReactProps(attrs)
      })
    );
  ...
  renderLink() {
    ...
    if (!link || !Array.isArray(link))
      return null;
    return link.map(
      (attrs, i) => React5.createElement("link", {
        key: i,
        ...toReactProps(attrs)
      })
    );
  ...
  renderScript() {
    ...
    return script.map((attrs, i) => {
      ...
      return React5.createElement("script", { key: i, ...props });
    });
  }
  renderStyle() {
    ...
    return style.map((attrs, i) => {
      ...
      return React5.createElement("style", { key: i, ...props });
    });
  }
  renderNoscript() {
    ...
    return noscript.map((attrs, i) => {
      ...
      return React5.createElement("noscript", { key: i, ...props });
    });
  }
  render() {
